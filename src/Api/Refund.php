...
trait Refund
{
     ...
     */
    public function sendRefundRequest(array $data): array
    {
        Validator::validate($data, [
            ...
            'vnp_TransactionType' => ['required', 'string', 'min:1', 'max:15', Rule::in(RefundTransactionType::getValues())],
            'vnp_TxnRef' => ['required'],
            ...
            'vnp_CreateBy' => ['required', 'string', 'min:1', 'max:245'],
